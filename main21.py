...
# bot = Client(
#    "bot",
#    bot_token=os.environ.get("8238253214:AAG2z4L4gFvT0oAk8mSS83zXH9kwQx19cBA"),
#    api_id=int(os.environ.get("24754824")),
#    api_hash=os.environ.get("e24a9c7a6aa24e1c56fa349e104ec20e")
# )
# auth_users = [ int(chat) for chat in os.environ.get("968292174").split(",") if chat != '']
# sudo_users = auth_users
# sudo_groups = [ int(chat) for chat in os.environ.get("-1003697437268").split(",")  if chat != '']
